...
class FirebaseRegisterRepositoryImpl implements RegisterRepository {
  final FirebaseRegisterDataSource _dataSource;

  FirebaseRegisterRepositoryImpl(this._dataSource);
  ...
  Future<RegisterEntity?> register({
    ...
    try {
      ...
      final age = _calculateAge(birthday);  // Placeholder; compute in use case and pass if repo needs it
